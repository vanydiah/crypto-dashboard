            ...
            <div className='form-elements'>
              <div className='form-line'>
                <div className='full-width'>
                  <label htmlFor='view'>View Bank Information</label>
        ...
        <div className='box-content box-horizontal-padding box-vertical-padding box-content-height-nobutton'>
          <form className='form' noValidate>
            <div className='form-elements'>
              <div className='form-line'>
                <div className='full-width'>
                  <label htmlFor='iban'>ID Number</label>
                  <input type='text' name='iban' id='iban' placeholder='ID Number' />
                </div>
              </div>
            </div>
          </form>
          ...
          <form className='form' noValidate>
            <div className='form-elements'>
              <div className='form-line'>
                <div className='full-width'>
                  <label htmlFor='view'>Registered</label>
                  <select name='view' id='view'>
                    <option value='ZB'>Maybank</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div className='box-text box-horizontal-padding center'>
            <p>
              <strong>ID00 0000 0000 0000 0000 0000 00</strong>
            </p>
            <p>
              <span>Amount to be withdrawn : </span>
              <strong>USD 2300000</strong>
            </p>
          </div>
